...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const int >::type estdist(estdistSEXP);
    rcpp_result_gen = Rcpp::wrap(estip(x, model0, N, bg0, fc0, ng, gc0, eMLL, eEM, eM, emu, esd, D, ic, max, min, mu, sigma, Bayes, method, mu_a, sigma_a, mu_b, sigma_b, mu_c, w_c, fix, print, min_a, maxabs_b, maxiter_em, maxiter_j, maxskip_j, rm_list, thdist, estdist));
    return rcpp_result_gen;
END_RCPP
}
// theta_pv
