...
#'res$SE
#'@export
estip <- function(x, model0 = as.character( c("2PL")), N = 31L, bg0 = 1L, fc0 = 2L, ng = 1L, gc0 = 2L, eMLL = 1e-6, eEM = 1e-4, eM = 1e-3, emu = 1e-3, esd = 1e-3, D = 1.702, ic = 1/5, max = 6.0, min = -6.0, mu = 0, sigma = 2, Bayes = 0L, mu_a = 0, sigma_a = 1, mu_b = 0, sigma_b = 2, mu_c = 1/5, w_c = 5, fix = 1L, print = 0L, min_a = 0.1, maxabs_b = 20, maxiter_em = 200L, maxiter_j = 20L, maxskip_j = 0L, rm_list = as.character( c("NONE")), thdist = "normal", EM_dist = 1L) {
